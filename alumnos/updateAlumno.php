...
<header class="header">
    <nav class="navegacion">
            ...
            <li class="nav-menu-item"><a href="#"class="nav-menu-link nav-link">ALUMNOS</a>
                <ul class="submenu">
						...
						<li class=""><a href="#">Gestionar</a></li>
    ...
    while($row=mysqli_fetch_array($resultado))
    {
        ...
        echo "<td> <a href='editar.php?id=".$row['num_Control']."'><button id='btnmodificar'>Editar</button></a></td>";
        echo "<td> <a href='eliminarAlumno.php?id=".$row['num_Control']."'><button id='btneliminar'>Eliminar</button></a></td>";
        echo "</tr>";        
    }
    echo "</table>";
    ?>
