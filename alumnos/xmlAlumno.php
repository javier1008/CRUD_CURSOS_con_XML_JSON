...
<header class="header">
    ...
    <br>
    <?php
    echo "<h2 id='tituloxml'>Datos de Alumnos en Formato XML</h2>";
    ...
    function mysql_XML($datos){
        ...
        while ($row = mysqli_fetch_array($datos)) {
            ...
            $contenido.="&nbsp &nbsp &lt;carrera&gt;".$row['carrera']."&lt;/carrera&gt;<br>";
            $contenido.="&nbsp &nbsp &lt;semestre&gt;".$row['semestre']."&lt;/semestre&gt;<br>";
            $contenido.="&nbsp &nbsp &lt;grupo&gt;".$row['grupo']."&lt;/grupo&gt;<br>";
