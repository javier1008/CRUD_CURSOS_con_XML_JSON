...
<header class="header">
    ...
    <hr> 
<form action="actualizar.php" method="POST" id="basic-form">
    <div class="container" align="center">
        <?php
          ...
          $consulta ="SELECT * FROM docente WHERE num_Control='$id'";
          ...
          if($resul){
            ...
            echo"<input type='text' placeholder='Nombre' class='input' name='nombre' value='{$sustraer['nombre']}' required><br>";//con el row va jalando los datos de la BD
            echo "<label>Apellido Paterno</label><br>";
            echo"<input type='text' placeholder='Nombre' class='input' name='apell_Paterno' value='{$sustraer['apell_Paterno']}' required><br>";
            echo "<label>Apellido Materno</label><br>";
            echo"<input type='text' placeholder='Nombre' class='input' name='apell_Materno' value='{$sustraer['apell_Materno']}' required><br>";
            echo "<label>Cedula Profesional</label><br>";
            echo"<input type='text' placeholder='Nombre' class='input' name='cedula' value='{$sustraer['cedula']}' required><br>";
            echo "<label>Curso</label><br>";
            echo"<input type='text' placeholder='Nombre' class='input' name='curso' value='{$sustraer['Curso']}' required><br><br>";            
            echo"<button type='submit' id='btnAceptar' class='signupbtn'>Actualizar</button>";
            echo"</div>";
            }
          }
          else{
