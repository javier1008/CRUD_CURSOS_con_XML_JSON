...
<header class="header">
    ...
    while($row=mysqli_fetch_array($resultado))
    {
        ...
        echo "<td> <a href='modificar.php?id=".$row['num_Control']."'><button id='btnmodificar'>Editar</button></a></td>";
        echo "<td> <a href='eliminarDocente.php?id=".$row['num_Control']."'><button id='btneliminar'>Eliminar</button></a></td>";
        echo "</tr>";        
    }
    echo "</table>";
    echo "</div>";
